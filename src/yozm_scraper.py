...
def get_article_links(driver, url):
    ...
    try:
        ...
        articles = driver.find_elements(By.CSS_SELECTOR, 'div.post_list > div.post_item')
...
def extract_article_content(driver, url):
    ...
    try:
        ...
        # 제목 추출
        title = driver.find_element(By.CSS_SELECTOR, "h1.post_title").text.strip()
        
        # 내용 추출
        content_element = driver.find_element(By.CSS_SELECTOR, "div.post_content")
...
def scrape_yozm_articles():
    """Yozm 기사를 스크래핑합니다."""
    try:
        driver = create_webdriver()
        base_url = "https://yozm.wishket.com/magazine/"
